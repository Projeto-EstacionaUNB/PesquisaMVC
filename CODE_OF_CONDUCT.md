...
Ocorrências de comportamentos abusivos, de assédio ou que sejam inaceitáveis por qualquer outro motivo poderão ser reportadas para a liderança da comunidade, responsável pela aplicação, via contato [@GabrielSilvs], no Telegram, um dos integrantes da equipe.

Todas as reclamações serão revisadas e investigadas o mais rápido possível e de maneira justa.
